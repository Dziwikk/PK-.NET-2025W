...
namespace LibraryApp.Services
{
    ...
    public class AnalyticsService
    {
        ...
        public string MostPopularItemTitle()
        {
            ...
            // Remis rozstrzygamy po najwyższym Id pozycji (nowsza wygrywa)
        ...
        public double LogPopularityScore(string title)
        {
            ...
            if (n <= 0) throw new ArgumentOutOfRangeException(nameof(title), "Popularity must be positive for logarithm.");
            return Math.Log(n);
        }
    }
}
